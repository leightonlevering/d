...
__IMPORTANT NOTE: When you install Python under Windows pay attention to add it to the PATH and to Disable PATH Limit Length__ (see the screenshot below)
